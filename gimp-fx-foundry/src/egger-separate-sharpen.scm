...
;
			(cond
				...
				((= InFlatten FALSE)
					(begin
						(gimp-drawable-set-name SharpenLightsLayer _"Sharpened Lights")
						(gimp-drawable-set-name SharpenShadowsLayer _"Sharpened Shadows")
...
(script-fu-register 
	...
	_"Separate _Lights&Shadows Sharpen"
	_"Separate Sharpening (Lights & Shadows)"
	...
	SF-ADJUSTMENT	_"Radius of USM"		'(3.0 0.0 50.0 1 0 2 0)
	SF-ADJUSTMENT	_"Amount of USM"		'(1.0 0.0 5.0 0.5 0 2 0)
	SF-ADJUSTMENT	_"Threshold"		'(0.0 0.0 50.0 1.0 0 2 0)
