...
(script-fu-register 
	...
	_"Smart Sharpening, Redux Version"
	"Martin Egger (martin.egger@gmx.net)"
	...
	SF-ADJUSTMENT	_"USM: Radius"		'(2.0 0.0 50.0 1 0 2 0)
	SF-ADJUSTMENT	_"USM: Amount"		'(1.0 0.0 5.0 0.5 0 2 0)
	SF-ADJUSTMENT	_"USM: Threshold"		'(0.0 0.0 50.0 1.0 0 2 0)
	SF-TOGGLE	_"Use refocus plugin"	FALSE
	SF-ADJUSTMENT	_"Refocus: Size of matrix"	 '(5.0 0.0 10.0 1.0 0 2 0)
	SF-ADJUSTMENT	_"Refocus: Circle radius"		 '(1.0 0.0 25.0 0.1 0 2 0)
	SF-ADJUSTMENT	_"Refocus: Parameter for Gaussian" '(0.0 0.0 25.0 0.1 0 2 0)
	SF-ADJUSTMENT	_"Refocus: Correlation"		 '(0.5 0.0 1.0 0.05 0 2 0)
	SF-ADJUSTMENT	_"Refocus: Noise to Signal ratio"	 '(0.01 0.0 1.0 0.01 0 2 0)
	SF-ADJUSTMENT	_"Edges: Detect Amount"	'(6.0 1.0 10.0 1.0 0 2 0)
	SF-ADJUSTMENT	_"Edges: Blur Pixels"	'(6.0 1.0 10.0 1.0 0 2 0)
