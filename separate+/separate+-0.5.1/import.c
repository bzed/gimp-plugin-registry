...
static gint      separate_import_dialog( struct SeparateContext *sc );
...
query (void)
{
  ...
  gimp_install_procedure ("plug_in_separate_import",
                          N_("Import the CMYK TIFF image"),
                          N_("Import the CMYK TIFF image"),
                          "Yoshinori Yamakawa",
                          "Yoshinori Yamakawa",
                          "2007-2008",
                          N_("<Toolbox>/File/Acquire/Separated TIFF"),
                          NULL,
                          GIMP_PLUGIN,
                          nargs, nrargs,
                          args, rargs );
...
static gint
separate_import_dialog( struct SeparateContext *sc )
{
