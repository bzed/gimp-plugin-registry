...
#ifndef SEPARATE_CORE_H
#define SEPARATE_CORE_H


void      separate_full      (GimpDrawable    *drawable,
                              GimpParam       *values,
                              SeparateContext *sc);
void      separate_light     (GimpDrawable    *drawable,
                              GimpParam       *values,
                              SeparateContext *sc);
void      separate_proof     (GimpDrawable    *drawable,
                              GimpParam       *values,
                              SeparateContext *sc);
void      separate_duotone   (GimpDrawable    *drawable,
                              GimpParam       *values,
                              SeparateContext *sc);
